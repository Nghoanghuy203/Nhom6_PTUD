...
public class ManHinhDangNhap1 extends JFrame{
	/**
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ManHinhDangNhap1 frame = new ManHinhDangNhap1();
	...
	public ManHinhDangNhap1() {
		...
		contentPane.setBounds(0, 0, 1360, 730);
		...
		btnShowPass.setIcon(new ImageIcon(ManHinhDangNhap1.class.getResource("/images/show.png")));
		...
		btnHidePass.setIcon(new ImageIcon(ManHinhDangNhap1.class.getResource("/images/eye-off.png")));
		...
		File f = new File(ManHinhDangNhap1.class.getResource("/images/logoAM.jpg").getFile());
		...
		textField.setBounds(220, 151, 300, 19);
		pnLogin.add(textField);
