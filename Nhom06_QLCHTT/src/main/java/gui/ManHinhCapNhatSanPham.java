...
public class ManHinhCapNhatSanPham extends JPanel {
	...
	public ManHinhCapNhatSanPham() {
		...
		btnSuaSP.setBounds(437, 160, 100, 30);
		...
		btnXoaTrangSP.setBounds(547, 160, 100, 30);
		pn_kqTimKiem.add(btnXoaTrangSP);
		
		JButton btnThemSP = new JButton("Thêm");
		btnThemSP.setBounds(324, 160, 100, 30);
