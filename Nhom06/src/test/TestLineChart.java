...
*/
    private void test() {
        ...
        chart.addData(new ModelChart("July", new double[]{350, 700, 150}));
        chart.addData(new ModelChart("August", new double[]{200, 50, 900}));
        chart.addData(new ModelChart("September", new double[]{350, 540, 500}));
        chart.addData(new ModelChart("June", new double[]{450, 800, 100}));
        chart.addData(new ModelChart("March", new double[]{200, 0, 900}));
        chart.addData(new ModelChart("April", new double[]{480, 700, 100}));
        chart.start();
        */
    }
