...
public class ManHinhChinh extends JFrame{
	...
	public void menuVertical(Color color1, Color color2, boolean isQL) {
		...
		MenuItem mn_nhacungcap = new MenuItem(new ImageIcon(ManHinhChinh.class.getResource("/images/icon_ncc.png")), "Nhà cung cấp", swithPanel(pn_body), true, color1, color2);
		...
		MenuItem mn_capnhatNV = new MenuItem(new ImageIcon(ManHinhChinh.class.getResource("/images/icon_capnhat.png")), "Cập nhật", swithPanel(pn_body), true, color1, color2);
		MenuItem mn_timkiemNV = new MenuItem(new ImageIcon(ManHinhChinh.class.getResource("/images/icon_timkiem.png")), "Tìm kiếm", swithPanel(pn_body), true, color1, color2);
		...
		MenuItem mn_thongkedoanhthu = new MenuItem(new ImageIcon(ManHinhChinh.class.getResource("/images/icon_tkdoanhthu.png")), "Thống kê doanh thu", swithPanel(pn_body), true, color1, color2);
		...
		if (isQL) {
			...
			mn_sanpham= new MenuItem(new ImageIcon(ManHinhChinh.class.getResource("/images/icon_sanpham.png")), "Sản phẩm", null, false, color1, color2, mn_capnhatSP, mn_timkiemSP, mn_mausac, mn_chatlieu, mn_loaiSP, mn_kichco, mn_nhacungcap);
			addMenu(mn_nhanvien, mn_dondathang, mn_khachhang, mn_sanpham, mn_hoadon, mn_CTKM);
		}
		else {
