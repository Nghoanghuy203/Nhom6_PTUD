...
public class ManHinhCapNhatChuongTrinhKhuyenMai extends JPanel {
	...
	public ManHinhCapNhatChuongTrinhKhuyenMai() {
		...
		pn_thaotac.setBorder(new TitledBorder(new LineBorder(new Color(65, 105, 225), 1, true), "Cập nhật thông tin chương trình khuyến mãi", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(65, 105, 225)));
		...
		pn_dsnv.setBorder(new TitledBorder(new LineBorder(new Color(65, 105, 225), 1, true), "Danh sách chương trình khuyến mãi", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(65, 105, 225)));
		...
		btnThemNV.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				String ma = GeneratorID.generateIDHoaDon();
				
				ChuongTrinhKhuyenMai ctkm = new ChuongTrinhKhuyenMai(ma, phanTramKM, ngayBatDau, ngayKetThuc, trangThai);
	...
	private void updateTable() {
		...
		for (ChuongTrinhKhuyenMai chuongTrinhKhuyenMai : dsKM) {
			Object data[] = {chuongTrinhKhuyenMai.getMaKM(),chuongTrinhKhuyenMai.getPhanTramKhuyenMai()+"",dtf.format(chuongTrinhKhuyenMai.getNgayBatDau()),dtf.format(chuongTrinhKhuyenMai.getNgayKetThuc()),chuongTrinhKhuyenMai.isTrangThai()};
